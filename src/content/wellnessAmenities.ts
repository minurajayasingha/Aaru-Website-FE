...
export const wellnessAmenities: IconAmenityItem[] = [
  { id: "clubhouse", name: "Clubhouse & Pool", description: "21,000 sqft", icon: "/images/icons/wellness/clubhouse-pool.svg" },
  { id: "dining", name: "Signature Dining", description: "Coastal Fusion", icon: "/images/icons/wellness/dining.svg" },
  { id: "yoga", name: "Yoga Shala", description: "Yoga", icon: "/images/icons/wellness/yoga.svg" },
  { id: "wellness", name: "Wellness & Spa", description: "Spa", icon: "/images/icons/wellness/wellness-spa.svg" },
  { id: "gym", name: "Gym", description: "Fitters", icon: "/images/icons/wellness/gym.svg" },
  { id: "coworking", name: "Co-working Spaces", description: "Work Remotely", icon: "/images/icons/wellness/coworking.svg" },
  { id: "connectivity", name: "24/7 Connectivity", description: "Starlink + Fibre", icon: "/images/icons/wellness/connectivity.svg" },
];
