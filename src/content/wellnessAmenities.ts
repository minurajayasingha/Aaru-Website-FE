...
export const wellnessAmenities: IconAmenityItem[] = [
  { id: "clubhouse", name: "Pool & Pool side Bar", description: "Relax & Unwind", icon: "/images/icons/wellness/clubhouse-pool.svg" },
  ...
  { id: "wellness", name: "Wellness & Spa", description: "Treatment Room", icon: "/images/icons/wellness/wellness-spa.svg" },
  { id: "gym", name: "Fitness Center", description: "Cardio & Resistance", icon: "/images/icons/wellness/gym.svg" },
