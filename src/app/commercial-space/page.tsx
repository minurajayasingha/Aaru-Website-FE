    ...
    <>
      ...
      <Reveal as="section" className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center">
        <div className="flex flex-col gap-4">
          <h2 className="font-heading font-bold text-heading-sm md:text-h-02 text-black">A World of Leisure</h2>
          <p className="font-body text-para-lg text-brand-forest-700">
